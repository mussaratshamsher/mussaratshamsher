...
### 🤖 Agentic AI Engineer • AI Automation • Full-Stack Developer

I build **AI agents, intelligent automation systems, digital employees, and full-stack AI applications** designed to solve real-world business problems.
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/mussaratshamsher/Capstone2-Backend_AI-Eng-Embedable_Widget/main/assets/leadforge-preview.png"
...
**LeadForge** is an AI-powered embeddable widget that engages website visitors, captures leads, and automates lead qualification.

**Tech Stack**

`Next.js` `TypeScript` `Python` `FastAPI` `AI Agents` `Supabase`
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/mussaratshamsher/digital-FTE/main/assets/digital-fte-preview.png"
...
**Digital FTE** is an AI-powered digital employee platform designed to automate business workflows using specialized AI agents.

**Tech Stack**

`Next.js` `FastAPI` `OpenAI Agents SDK` `PostgreSQL` `Docker` `Kubernetes`
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/mussaratshamsher/Afynix-Digital/main/Week4-Content_Analyzer/assets/content-analyzer-preview.png"
...
An AI-powered platform that analyzes digital content and generates **actionable optimization insights**.

**Tech Stack**

`Next.js` `TypeScript` `Python` `FastAPI` `AI`
...
<p align="center">
  <img
    src="https://raw.githubusercontent.com/mussaratshamsher/Nexe-Agentic-AI-Intern/master/02-Intermediate-level/assets/physical-ai-preview.png"
...
An AI-powered learning experience combining **technical knowledge with conversational AI** to explore Physical AI and humanoid robotics.

**Tech Stack**

`Python` `Streamlit` `OpenAI` `Agentic AI`
...
I combine software engineering with **design, branding, and digital growth**.
...
This combination allows me to approach products from **engineering, design, usability, and growth** perspectives.
...
<p align="center">
  <img
    width="49%"
    src="https://github-readme-stats-sigma-nine-80.vercel.app/api?username=mussaratshamsher&show_icons=true&theme=transparent&hide_border=true&rank_icon=github"
    alt="GitHub Stats"
  />
  <img
    width="49%"
    src="https://github-readme-streak-stats-eight.vercel.app/?user=mussaratshamsher&theme=transparent&hide_border=true"
    alt="GitHub Streak"
  />
</p>
...
<p align="center">
  <strong>Agentic AI Engineer • AI Automation • Full-Stack Development</strong>
</p>
